...
:: Генерация уникального пароля (до 20 цифр)
set PROXY_KEY=%RANDOM%%RANDOM%%RANDOM%%RANDOM%%RANDOM%

:: Создание JSON-метаданных с привязкой пароля (Bindings)
...
:: Парсинг субдомена из JSON ответа
...
del meta.json deploy_log.txt sub_log.txt
pause
